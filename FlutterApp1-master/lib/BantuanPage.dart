...
class _MyBantuanPage extends State<BantuanPage> {
  int currentIndex = 2; // Atur indeks awal ke 2 (Bantuan)
  bool isLoggedIn = true; // Tandai apakah pengguna sudah login atau belum
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        // Jangan izinkan kembali jika pengguna telah logout
        return !isLoggedIn;
      },
      child: Scaffold(
        appBar: AppBar(
          title: Text('Bantuan'),
          automaticallyImplyLeading: isLoggedIn, // Tampilkan tombol kembali hanya jika pengguna sudah login
        ),
              ...
              onTabChange: (index) {
                ...
                switch (index) {
                  ...
                  case 1:
                    ...
                    break;
                  case 2:
                    // Tidak perlu navigasi karena kita sudah di halaman bantuan
                    break;
                }
              },
              tabs: const [
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
            // Teks panduan penggunaan aplikasi
